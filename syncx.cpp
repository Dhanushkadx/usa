...
void syncx :: autoEvent_activator(unsigned int spi_number){
	Serial.print("received spi No:");
	Serial.print(spi_number);
	Serial.print(":");
	Serial.print("auto index");
	Serial.print(":");
	Serial.print(autoEvent_Index);
	Serial.print(":");
	Serial.print(sync_data[autoEvent_Index][0]);
	Serial.print(":");
	Serial.print(sync_data[autoEvent_Index][1]);
