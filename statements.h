...
// iot
unsigned long iot_data_refresh_interval;
// spi emulator
...
volatile unsigned int previousSPI=0,currentSPI=0;
...
boolean automatic_foot_lifting = false;
boolean automatic_ap_start = false;
boolean continuous_cycle_ap = false;
boolean automatic_foot_lifting_with_trim = false;
...
//LCD
boolean LCD_Event_sd = false;
boolean LCD_Event_dac_module = false;
